...
namespace WebAppBlogMvc.Controllers
{
    public class BlogInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BlogId,Title,Subject,DateOfCreation,BolgUrl,EmpEmailId")] BlogInfo blogInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BlogId,Title,Subject,DateOfCreation,BolgUrl,EmpEmailId")] BlogInfo blogInfo)
        {
            if (ModelState.IsValid)
            {
